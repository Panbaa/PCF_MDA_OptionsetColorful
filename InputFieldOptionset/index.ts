...
export class InputFieldOptionset implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public updateView(context: ComponentFramework.Context<IInputs>): void
	{
        ...
        this.container.style.backgroundColor = this._colorInRgb;
        this.inputElement.style.backgroundColor = this._colorInRgb;
        this.renderSelected();
	}
